...
public class PlaceService
{
    ...
    {
        { "正餐", new() { "牛肉麵", "滷肉飯", "火鍋", "熱炒", "義大利麵", "拉麵", "壽司", "鵝肉", "咖哩飯", "定食", "排骨便當", "泰式料理", "韓式料理", "披薩", "水餃", "鐵板燒", "生魚片", "漢堡", "素食/蔬食", "早午餐", "茶餐廳", "丼飯", "烏龍麵", "烤肉飯", "健康餐", "越南河粉", "涼麵", "牛排", "石鍋拌飯", "印度咖哩", "北京烤鴨", "壽喜燒", "麻辣鍋", "酸菜白肉鍋", "羊肉爐", "薑母鴨", "海南雞飯", "肉骨茶", "炒飯", "炒麵", "便當", "豬排飯", "鰻魚飯", "蕎麥麵", "義式燉飯", "法式料理", "西班牙海鮮燉飯", "美式餐廳", "墨西哥捲餅", "沙拉", "夏威夷拌飯", "控肉飯", "雞肉飯", "燒臘", "小籠包", "蒸餃", "鍋貼", "自助餐", "牛肉湯", "客家小炒", "海鮮餐廳" } },
        { "小吃/宵夜", new() { "臭豆腐", "滷味", "鹹酥雞", "雞排", "蚵仔煎", "燒烤", "串燒", "大腸包小腸", "地瓜球", "麵線", "水煎包", "章魚燒", "甜不辣", "肉圓", "鹽水雞", "刈包", "蔥油餅", "烤香腸", "肉羹", "四神湯", "米糕", "生煎包", "炸雞", "烤玉米", "關東煮", "清粥小菜", "豬血糕", "肉燥飯", "地瓜薯條", "炸魷魚", "黑輪", "豬血湯", "貢丸湯", "蛤蜊湯", "白糖粿", "狀元糕", "雙胞胎", "炸鮮奶", "菱角酥", "胡椒餅", "韭菜盒", "宵夜豆漿", "飯糰", "燒餅油條", "蛋餅", "蘿蔔糕", "麻辣燙", "砂鍋粥" } },
        { "甜點/下午茶", new() { "咖啡", "甜點", "蛋糕", "鬆餅", "茶", "冰品", "豆花", "珍珠奶茶", "車輪餅", "肉桂捲", "下午茶", "書店", "手搖飲", "千層蛋糕", "司康", "馬卡龍", "蛋塔", "布丁", "刨冰", "雪花冰", "舒芙蕾", "可麗露", "果汁", "熱仙草", "貓咪咖啡廳", "特色酒吧", "紅豆湯", "綠豆湯", "花生湯", "燒仙草", "地瓜湯", "水果冰", "芒果冰", "綿綿冰", "芋圓", "粉圓冰", "檸檬塔", "生乳捲", "可頌", "法式吐司", "蜜糖吐司", "雞蛋仔", "提拉米蘇", "布朗尼", "可可", "抹茶", "花草茶", "冰沙", "氣泡飲", "微醺特調", "精釀啤酒", "深夜甜點", "海景咖啡", "老宅咖啡", "桌遊店", "和菓子" } }
    };
